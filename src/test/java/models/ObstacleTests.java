...
public class ObstacleTests {
    ...
    private final Obstacle obstacle = new Obstacle("Obstacle1", 123.1);

    @DisplayName("Testing Obstacle Name")
    @Test
    public void testObstacleName() {
       var name = obstacle.getName();
       assertEquals("Obstacle1", name, "Obstacle Name should be \"Obstacle 1\".");
    }

    @DisplayName("Testing Obstacle Height")
    @Test
    public void testObstacleHeight() {
